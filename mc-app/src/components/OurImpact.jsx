        ...
        <div className="impact-content">
            ...
            <div className="impact-grid">
                ...
                <div className="column">
                    ...
                    <p className="futura-book">We support other <strong>student food ventures and local businesses</strong> by providing a testing ground on campus. We sell baked goods from <a href="https://heellife.unc.edu/organization/thesondermarket"><em>The Sonder Market</em></a>, a student-run initiative that combats food insecurity in our community. We source our coffee from <a href="https://carrborocoffee.com/"><em>Carrboro Coffee Roasters</em></a>, a sustainable roastery just down the road.</p>
                </div>
            </div>
