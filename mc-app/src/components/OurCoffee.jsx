    ...
    return (<>
        <Container>
            <Row className="pt-5">
                ...
                <Col>
                    <div className="vertical-center my-auto">
                        <h2 className="futura-heavy">Delicious and Ethical.</h2>
                        <p className="futura-book header-descr">The Meantime partners with Carrboro Coffee Roasters, "the premiere small-batch artisan roaster in the Carrboro/Chapel Hill area and beyond," to bring UNC the finest and freshest coffee from around the world.</p>
                    </div>
                </Col>
            </Row>
            <Row>
                <Col>
                    <div className="menu text-center futura-book">
                        <h1 className="menu-title futura-heavy">OUR MENU</h1>
